...
//                                                        .then(
//                                                                // Registering the blockstate argument with the correct registry access
//                                                                CommandManager.argument("blocktype", BlockStateArgumentType.blockState(commandRegistryAccess))
...
//        BlockState blocktype = BlockStateArgumentType.getBlockState(context, "blocktype").getBlockState();
//
...
//        List<BlockPos> Pos = AStarPathFinder.findPath(start, end, world);
//
...
//
//            if (world.getBlockState(pos).isAir() || world.getBlockState(pos).isReplaceable() || world.getBlockState(pos).isOf(Blocks.TALL_GRASS) || world.getBlockState(pos).isOf(Blocks.SHORT_GRASS) || world.getBlockState(pos).isOf(Blocks.CORNFLOWER) || world.getBlockState(pos).isOf(Blocks.DANDELION) || world.getBlockState(pos).isOf(Blocks.POPPY)) {
